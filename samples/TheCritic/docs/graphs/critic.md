...
criticname[/"input <br> id='critic-name'"/]:::input -- "article->article" --> promptTemplate3["promptTemplate <br> id='promptTemplate-3'"]
...
criticname[/"input <br> id='critic-name'"/]:::input -- "id->id" --> output1{{"output <br> id='output-1'"}}:::output
